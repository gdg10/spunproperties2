        ...
        <Container style={conSty}>
          <Suspense fallback={<div>Loading...</div>}>
            <Switch>
              ...
              <Route path={"/" + SpunProperties[17].route} key="17_uni">
                {backToActiveProps()}
                <Property
                  underAgreement={SpunProperties[17].underAgreement}
                  price={SpunProperties[17].price}
                  details={SpunProperties[17].details}
                  address={SpunProperties[17].address}
                  listingAgent={SpunProperties[17].listingAgent}
                  description={SpunProperties[17].description}
                  propImages={SpunProperties[17].imageGallery}
                  listingAgentsPhone={SpunProperties[17].listingAgentsPhone}
                />
                <Active />
              </Route>
              <Route path={"/" + SpunProperties[18].route} key="18_uni">
                {backToActiveProps()}
                <Property
                  underAgreement={SpunProperties[18].underAgreement}
                  price={SpunProperties[18].price}
                  details={SpunProperties[18].details}
                  address={SpunProperties[18].address}
                  listingAgent={SpunProperties[18].listingAgent}
                  description={SpunProperties[18].description}
                  propImages={SpunProperties[18].imageGallery}
                  listingAgentsPhone={SpunProperties[18].listingAgentsPhone}
                />
                <Active />
              </Route>
